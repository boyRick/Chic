...
if slaughtered then
	...
	exports['esx-taskbar']:taskBar(7500, 'Putting the chicken in the box')
	TriggerServerEvent("yow:boy")
...
local dict = 'anim@amb@business@coc@coc_unpack_cut_left@'
	...
	exports['esx-taskbar']:taskBar(10000, 'Cutting the Rooster')
end
	...
	ClearPedTasks(GetPlayerPed(-1))
	slaughtered = true
	TriggerServerEvent("take:chicken")
	notyow = false
else
...
LoadDict('anim@heists@box_carry@')
	...
	ClearPedTasks(GetPlayerPed(-1))
	DeleteEntity(prop)
	TriggerServerEvent("give:chicken")
	notyow = true
	end
end
end
...
Citizen.CreateThread(function()
	...
	Citizen.Wait(0)
		if ragdoll then
			...
			TriggerEvent('esx-hospital:client:ResetLimbs')
            TriggerEvent('esx-hospital:client:RemoveBleed')
			ragdoll = false
		end
	end
end)
...
function SellChicken1()
if Sellchicken1 then
local x,y,z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.9, -0.98))
	...
	exports['esx-taskbar']:taskBar(5000, 'Selling the chicken!')
	...
	ClearPedTasks(GetPlayerPed(-1))
	DeleteEntity(prop)
	TriggerServerEvent("take:packaged_chicken")
